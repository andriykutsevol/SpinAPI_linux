...
main (int argc, char **argv)
{
  ...
  printf ("Copyright (c) 2010 SpinCore Technologies, Inc.\n\n");
	...
	// the board appropriately.
	 while (1) {
		read_float_exit_on_error ("Enter amplitude for pulse 1 (value from 0.0 to 1.0): ", &amp1);

		read_float_exit_on_error ("Enter amplitude for pulse 2 (value from 0.0 to 1.0): ", &amp2);

		read_float_exit_on_error ("Enter RF frequency (in MHz): ", &freq);
